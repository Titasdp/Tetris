...
class TBlock {
    ...
    composeBlock3() {
        ...
        for (let i = 0; i < 4; i++) {
            ...
            if (i == 0) {
                ...
                this.saveX = this.xIncrement
                this.y = this.y + this.size //increment y so that the second line of squares will be created
                this.xIncrement = this.xIncrement + 0
    ...
    confTransition1(X, Y) {
        ...
        for (let i = 0; i < 4; i++) {
            ...
            if (i == 1) {
                xIncrement = saveX
                Y = saveY
                xIncrement = xIncrement + this.size
            }
            if (i == 2) {
                xIncrement = saveX
                xIncrement = xIncrement - this.size
    ...
    /**
     * function that returns an "alert" to the system telling that the obj has arrived the object 
     * *completed
     */
    returnArrival() {
