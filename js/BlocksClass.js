...
export default class Block {
    constructor(takenSquares, blockType, W, H, context) {
    ...
    updateFormation() {
        // if (this.blockType == 1 || this.blockType == 2 || this.blockType == 3 || this.blockType == 4 || this.blockType == 5 || this.blockType == 6) {
